                ...
                for j in np.arange(n_wfms):
                    ...
                    if self.params['cycle_waveforms']:
                        ...
                        while on_correct_waveform == False and n < 10:
                            ...
                            qt.msleep(0.2)
                        if n == 10:
                            print 'Waveform did not change to the correct one in the 10 tries! Stopping measurement. Last waveform get was %s' % cur_wfm
                            self._scan_on = False

                        print 'Waveform index %d -- waveform %d/%d, wavelength %d/%d.' % (int(self.params['waveform_list'][j]), j+1, n_wfms, k+1, n_wls)
